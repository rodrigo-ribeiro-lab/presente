...
with st.container(border=True):
    ...
    with coreano:
        st.image("fotos/coreano.jpeg", caption="Jantar coreano", use_container_width=False, width=400)
    with filme:
        st.image("fotos/lalaland.jpg", caption="La La Land", use_container_width=False, width=400)
    st.write(" ")
...
with st.container(border=True):
    ...
    with jantar:
        st.image("fotos/thai.jpeg", caption="Jantar tailandês", use_container_width=False, width=200)
    with serie:
        st.image("fotos/lupin.jpeg", caption="Nossa série", use_container_width=False, width=600)
    ...
    with primeira_expectativa:
        st.image("fotos/mario.jpeg", caption="Mario: expectativa", use_container_width=False, width=600)
    with primeira_realidade:
        st.image("fotos/mario_realidade.jpeg", caption="Mario: realidade", use_container_width=False, width=400)
    segunda_expectativa, segunda_realidade = st.columns(2, gap="large")
    with segunda_expectativa:
        st.image("fotos/char_expectativa.jpeg", caption="Charmander: expectativa", width=350)
    with segunda_realidade:
        st.image("fotos/char_realidade.jpeg", caption="Charmander: realidade", width=600)
    ...
    st.image("fotos/sushi.jpeg", caption="Japones juntos", width=400, use_container_width=False)
...
with st.container(border=True):
    ...
    with holanda:
        st.image("fotos/holanda.jpeg", caption="Holanda", width=600)
    with paris:
        st.image("fotos/paris.jpeg", caption="Paris", width=400)
    st.write("**2027** • Brasil e América do Sul")
    brasil, america = st.columns(2, gap="large")
    with brasil:
        st.image("fotos/ubatuba.jpeg", caption="Brasil", width=550)
    with america:
        st.image("fotos/peru.jpeg", caption="América do Sul", width=600)
    st.write("**2028** • Olimpíadas em Los Angeles e passeio pela California")
    la28, golden = st.columns(2, gap="large")
    with la28:
        st.image("fotos/la28.jpeg", caption="Los Angeles 2028", width=500)
    with golden:
        st.image("fotos/california.jpeg", caption="California", width=600)
